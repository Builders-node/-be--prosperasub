...
-- broke the food listing at run time: the whole catalog call threw 42P01 and
-- the page rendered "Couldn't load restaurants".
--
-- Ratings now come from provider_reviews, which is keyed by the UNIVERSAL
-- providers.id. This RPC's callers know restaurants by their legacy
