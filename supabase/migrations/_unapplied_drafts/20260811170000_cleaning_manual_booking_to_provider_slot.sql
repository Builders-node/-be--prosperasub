...
-- in frontend/src/integrations/supabase/client.ts looked slots up by date and
-- time alone, which since grids became per-provider could match another
-- provider's hour entirely — and inserted shared-grid rows for everyone.
--
